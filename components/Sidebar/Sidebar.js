          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
              <li className="inline-flex">
                <a
                  href="https://www.huper.net/learning-lab/tailwind/nextjs/colors/notus"
                  target="_blank"
              ...
              <li className="inline-flex">
                <a
                  href="https://www.huper.net/learning-lab/tailwind/nextjs/alerts/notus"
                  target="_blank"
                  className="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold"
                >
              ...
              <li className="inline-flex">
                <a
                  href="https://www.huper.net/learning-lab/tailwind/angular/overview/notus"
                  target="_blank"
                  className="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold"
                >
              ...
              <li className="inline-flex">
                <a
                  href="https://www.huper.net/learning-lab/tailwind/js/overview/notus"
                  target="_blank"
                  className="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold"
                >
              ...
              <li className="inline-flex">
                <a
                  href="https://www.huper.net/learning-lab/tailwind/nextjs/overview/notus"
                  target="_blank"
                  className="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold"
                >
              ...
              <li className="inline-flex">
                <a
                  href="https://www.huper.net/learning-lab/tailwind/react/overview/notus"
                  target="_blank"
                  className="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold"
                >
                  <i className="fab fa-react mr-2 text-gray-400 text-base"></i>
              ...
              <li className="inline-flex">
                <a
                  href="https://www.huper.net/learning-lab/tailwind/svelte/overview/notus"
                  target="_blank"
                  className="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold"
                >
              ...
              <li className="inline-flex">
                <a
                  href="https://www.huper.net/learning-lab/tailwind/vue/overview/notus"
                  target="_blank"
                  className="text-gray-800 hover:text-gray-600 text-sm block mb-4 no-underline font-semibold"
                >
